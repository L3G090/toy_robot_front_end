    ...
    move() {
        ...
        switch (this.robotInfo.f) {
            case DIRECTION.NORTH || DIRECTION.SOUTH:
                if (this.robotInfo.y - 1 >= 0) { this.robotInfo.y -= 1; }
                break;
            case DIRECTION.WEST:
                if (this.robotInfo.x - 1 >= 0) { this.robotInfo.x -= 1; }
                break;
            case DIRECTION.SOUTH:
                if (this.robotInfo.y + 1 < MAX_LENGHT) { this.robotInfo.y += 1; }
                break;
            case DIRECTION.EAST:
                if (this.robotInfo.x + 1 < MAX_LENGHT) { this.robotInfo.x += 1; }
                break;
        }
